                         ...
                         ErrorResult& out_rv)
{
    ...
    tex->TexImage(funcName, funcDims, target, level, internalFormat, width, height, depth,
                  border, unpackFormat, unpackType, maybeView, &out_rv);
}
                            ...
                            ErrorResult& out_rv)
{
    ...
    tex->TexSubImage(funcName, funcDims, target, level, xOffset, yOffset, zOffset,
                     width, height, depth, unpackFormat, unpackType, maybeView, &out_rv);
}
                            ...
                            dom::ImageData* imageData, ErrorResult& out_rv)
{
    ...
    tex->TexSubImage(funcName, funcDims, target, level, xOffset, yOffset, zOffset,
                     unpackFormat, unpackType, imageData, &out_rv);
}
                                   ...
                                   const dom::ArrayBufferViewOrSharedArrayBufferView& view)
{
    ...
    tex->CompressedTexImage2D(target, level, internalFormat, width, height, depth, border,
                              view);
}
                                      ...
                                      const dom::ArrayBufferViewOrSharedArrayBufferView& view)
{
    ...
    tex->CompressedTexSubImage2D(target, level, xOffset, yOffset, zOffset, width, height,
                                 depth, sizedUnpackFormat, view);
}
                             ...
                             GLint border)
{
    ...
    tex->CopyTexImage(target, level, internalFormat, x, y, width, height, border);
}
                                ...
                                GLsizei height)
{
    ...
    tex->CopyTexSubImage2D(target, level, xOffset, yOffset, zOffset, x, y, width, height);
}
