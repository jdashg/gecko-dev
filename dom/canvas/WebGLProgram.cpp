...
bool
WebGLProgram::FindUniformUserNameByMappedName(const nsACString& mappedName,
                                              nsCString* const out_userName) const
{
    if (mVertShader->FindUniformUserNameByMappedName(mappedName, out_userName))
        return true;

    if (mFragShader->FindUniformUserNameByMappedName(mappedName, out_userName))
        return true;
