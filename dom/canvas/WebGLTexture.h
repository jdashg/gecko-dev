...
private:
    ...
    const ImageInfo& BaseImageInfoAtFace(size_t face) const {
        return ImageInfoAtFace(face, mBaseMipmapLevel);
    }
...
public:
    ...
    void GenerateMipmap(TexTarget target);
